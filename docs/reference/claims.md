...
| AKS Terraform is CI-validated, while the actual AKS apply remains a next-release, human-approved step. | planned | [Active plan, Phase 10](../../plans/2026-09-13-vllm-awq-benchmark-fulldata-training-and-aks-deployment.md#phase-10--azure-terraform-data-batch-vm-experiment-storage-aks-budgets-inert-deploy-workflow-iac-scanning) |
