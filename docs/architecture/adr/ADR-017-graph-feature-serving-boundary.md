...
metrics, and curation contracts** are **frozen as of this ADR's acceptance (2026-07-14),
before any new holdout result was inspected**, and are pinned in machine-validated form in
`config/gfp-benchmark.yaml`
...
any multi-hop detection lift the study measures — global *or*
...
a new ADR **plus a security review** revisits this boundary — never by
